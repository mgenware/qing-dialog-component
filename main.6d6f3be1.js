...
/**
    ...
    `}firstUpdated(){document.addEventListener("keyup",this.handleKeyUp.bind(this))}render(){return mt`
      <div
    ...
    `}updated(t){t.has(Vt)&&!!t.get(Vt)!==this.open&&setTimeout((()=>this.onOpenChanged()),0)}onOpenChanged(){this.dispatchEvent(new CustomEvent("openChanged",{detail:this.open}))}handleKeyUp(t){this.open&&("Escape"===t.key||"Esc"===t.key?this.dispatchEvent(new CustomEvent("escKeyDown")):"Enter"===t.key&&this.dispatchEvent(new CustomEvent("enterKeyDown")))}};Wt([zt({type:Boolean,reflect:!0})],Kt.prototype,"open",void 0),Kt=Wt([Lt("qing-overlay")],Kt);const Zt=r`
  button {
    background-color: #e7e7e7;
    color: black;
    border: 0;
...
`;class Ft extends Ot{render(){return mt` <h2>Title</h2>
      <p>
  ...
  `],customElements.define("dynamic-content",Ft);class Jt extends Ot{render(){return mt`
      <div id="main">
        <h2>Layouts</h2>
